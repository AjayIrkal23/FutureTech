...
class Client extends Component {
  componentDidMount() {
    ...
    $(".testimonial-main-slider").slick({
      ...
      fade: true,
      prevArrow:
        '<span class="slick-prev"><img src="' +
        publicUrl +
        'assets/img/icon/arrow-left-blue.png" alt="img" /></span>',
      nextArrow:
        '<span class="slick-next"><img src="' +
        publicUrl +
        'assets/img/icon/arrow-right-pink.png" alt="img" /></span>',
  ...
  render() {
    ...
    return (
      <div
        className="shape-3"
        style={{
          backgroundImage: "url(" + publicUrl + "assets/img/shape/3.png)"
        }}
      >
        {/* testimonial-area start */}
        <div
          className="testimonial-area pd-top-80 common-pd-bottom left-bottom-line-bg"
          style={{
                ...
                <div className="testimonial-thumb-slider-wrap">
                  {data.items.map((item, i) => (
                    <img
                      key={i}
                      className={
                        "testimonial-thumb-slider--img testimonial-thumb-slider--img-" +
                        item.number
                      }
                      src={
